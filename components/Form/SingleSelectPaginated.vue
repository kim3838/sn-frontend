<template>
    <v-select
        ...
        <template v-slot:prepend-item>
            ...
            <div class="tw-h-px tw-w-full tw-bg-gradient-to-r tw-from-accent tw-via-transparent tw-to-accent"></div>
        ...
        <template v-slot:item="{ active, item, attrs, on }">
            <v-list-item dense v-on="on" v-bind="attrs" #default="{ active }">
                <v-row dense no-gutters align="center">
                    <v-icon v-if="false" class="tw-text-gray-500 tw-h-[1rem] tw-w-[1rem]">mdi-square-small</v-icon>
